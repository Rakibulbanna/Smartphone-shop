...
const Aboutus = () => {
    return (
        <div className="container">
            <h2 className="section-heading">About Our smartphone & Our Shop</h2>
            ...
            <div className="row my-5">
                ...
                <div style={{ textAlign: 'left' }} className="col-md-6">
                    <div className="my-2">
                        <h3>Leading Computer, Laptop & smartphone  & Online Shop in Bangladesh</h3>
